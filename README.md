...
## System Diagram
My temperature sensor will sense the temperature and with the help of raspberry pi it will show the output on the computer screen. You can also use LCD display to show the readings of the temperature.
